//
//  YeraSlideSwitch.swift
//  SayWhere
//  仿HomeKit开关样式
//  Created by Yerassyl Yerlanov on 2017/2/3.
...
class YeraSlideSwitch:  UIView{
    
    override func draw(_ rect: CGRect) {
        self.backgroundColor = UIColor.white;
        //Add in the background of the switch
        ...
        //Add gesture action
        let panGesture = UIPanGestureRecognizer.init(target: self, action: #selector(YeraSlideSwitch.pangesture(sender:)));
